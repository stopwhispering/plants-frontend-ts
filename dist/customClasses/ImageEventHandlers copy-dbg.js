sap.ui.define(["sap/m/MessageToast", "plants/ui/customClasses/Util", "plants/ui/customClasses/Navigation", "sap/ui/base/ManagedObject"], function (MessageToast, Util, __Navigation, ManagedObject) {
  ...
  ImageEventHandlers.getInstance = function getInstance() {
    if (!ImageEventHandlers._instance) {
      ImageEventHandlers._instance = new ImageEventHandlers();
    }
    return ImageEventHandlers._instance;
  };
  return ImageEventHandlers;
});
//# sourceMappingURL=ImageEventHandlers copy.js.map