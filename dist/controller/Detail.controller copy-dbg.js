sap.ui.define(["plants/ui/customClasses/BaseController", "sap/ui/model/json/JSONModel", 'sap/ui/model/Filter', 'plants/ui/model/formatter', 'sap/m/MessageBox', "sap/m/MessageToast", "plants/ui/customClasses/Util", "plants/ui/customClasses/Navigation", "plants/ui/customClasses/MessageUtil", "plants/ui/model/ModelsHelper", "plants/ui/customClasses/EventsUtil", "sap/ui/model/Sorter", "sap/ui/model/FilterOperator", "plants/ui/customClasses/ImageToTaxon", "plants/ui/customClasses/PropertiesUtil", "plants/ui/customClasses/ImageUtil", "plants/ui/customClasses/TraitUtil", "plants/ui/customClasses/TaxonomyUtil"], function (BaseController, JSONModel, Filter, formatter, MessageBox, MessageToast, Util, Navigation, MessageUtil, ModelsHelper, EventsUtil, Sorter, FilterOperator, ImageToTaxon, PropertiesUtil, ImageUtil, TraitUtil, TaxonomyUtil) {
  "use strict";
  ...
  return BaseController.extend("plants.ui.controller.Detail", {
    ...
    _loadEventsForCurrentPlant: function () {
      ...
      $.ajax({
        ...
        context: this,
        async: true
      }).done(this._onReceivingEventsForPlant.bind(this, this._currentPlantId)).fail(this.ModelsHelper.getInstance().onReceiveErrorGeneric.bind(this, 'Event (GET)'));
    },
    ...
    onChangeActiveSwitch: function (evt) {
      if (!evt.getParameter('state')) {
        ...
        this.applyToFragment('dialogCancellation', o => o.openBy(oSwitch), _initCancellationDialog.bind(this));
    ...
    onPressButtonDeletePlant: function (evt, sPlant, plantId) {
      ...
      MessageBox.confirm("Delete plant " + sPlant + "?", {
    ...
    _confirmDeletePlant: function (sPlant, plantId, oBindingContextPlants, sAction) {
      ...
      $.ajax({
        ...
        context: this
      }).done(this._onPlantDeleted.bind(this, oBindingContextPlants)).fail(ModelsHelper.getInstance().onReceiveErrorGeneric.bind(this, 'Plant (DELETE)'));
    },
    ...
    onOpenAddTagDialog: function (evt) {
      ...
      this.applyToFragment('dialogAddTag', o => o.openBy(oButton), _initTagDialog.bind(this));
      function _initTagDialog(oDialog) {
        var dObjectStatusSelection = {
    ...
    onPressButtonSubmitClonePlant: function (oEvent) {
      ...
      $.ajax({
        ...
        contentType: "application/json",
        context: this
      }).done(this._onReceivingPlantCloned).fail(ModelsHelper.getInstance().onReceiveErrorGeneric.bind(this, 'Clone Plant (POST)'));
    },
    ...
    onPressButtonSubmitRenamePlant: function (evt) {
      ...
      $.ajax({
        ...
        context: this
      }).done(this._onReceivingPlantNameRenamed).fail(ModelsHelper.getInstance().onReceiveErrorGeneric.bind(this, 'Plant (PUT)'));
    },
    ...
    requestImagesForPlant: function (plant_id) {
      ...
      $.ajax({
        ...
        context: this,
        async: true
      }).done(this._onReceivingImagesForPlant.bind(this, plant_id)).fail(ModelsHelper.getInstance().onReceiveErrorGeneric.bind(this, 'Plant Images (GET)'));
    },
    ...
    _generateNewPlantNameSuggestion: function (parentPlantName, parentPlantPollenName = undefined, hasParentPlantPollen) {
      ...
      var includeParentPlantPollen = hasParentPlantPollen === true && parentPlantPollenName && parentPlantPollenName.trim().length;
      ...
      if (includeParentPlantPollen) {
        ...
        var suggestedName = (parentPlant.botanical_name || parentPlantName) + ' × ' + (parentPlantPollen.botanical_name || parentPlantPollenName);
        if (this.isPlantNameInPlantsModel(suggestedName)) {
    ...
    updatePlantNameSuggestion: function () {
      ...
      var suggestedName = this._generateNewPlantNameSuggestion(descendantPlantData.parentPlant, descendantPlantData.parentPlantPollen, propagationType.hasParentPlantPollen);
...
//# sourceMappingURL=Detail.controller copy.js.map